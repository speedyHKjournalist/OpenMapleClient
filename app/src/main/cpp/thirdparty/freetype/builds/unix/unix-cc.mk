...
#
CPPFLAGS := 
CFLAGS   := -c -Wall -g -O2 -fvisibility=hidden -DDARWIN_NO_CARBON   -I/opt/homebrew/opt/libpng/include/libpng16 -I/opt/homebrew/Cellar/harfbuzz/8.2.1/include/harfbuzz -I/opt/homebrew/opt/freetype/include/freetype2 -I/opt/homebrew/opt/libpng/include/libpng16 -I/opt/homebrew/Cellar/glib/2.78.0/include/glib-2.0 -I/opt/homebrew/Cellar/glib/2.78.0/lib/glib-2.0/include -I/opt/homebrew/opt/gettext/include -I/opt/homebrew/Cellar/pcre2/10.42/include -I/opt/homebrew/Cellar/graphite2/1.3.14/include -pthread \
...
# Linker flags.
#
LDFLAGS :=  -lz -lbz2 -L/opt/homebrew/opt/libpng/lib -lpng16 -L/opt/homebrew/Cellar/harfbuzz/8.2.1/lib -lharfbuzz -pthread -lpthread
