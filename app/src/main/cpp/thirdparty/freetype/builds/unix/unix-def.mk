...
MKINSTALLDIRS   := /Users/renruisi/AndroidStudioProjects/OpenMapleClient/app/src/main/cpp/thirdparty/freetype/builds/unix/./install-sh -c -d
...
#
prefix       := /Users/renruisi/AndroidStudioProjects/OpenMapleClient/app/src/main/cpp/thirdparty/freetype-build
exec_prefix  := ${prefix}
...
PKGCONFIG_REQUIRES         := 
PKGCONFIG_REQUIRES_PRIVATE := zlib, libpng, harfbuzz >= 2.0.0
PKGCONFIG_LIBS             := -L${libdir} -lfreetype
PKGCONFIG_LIBS_PRIVATE     := -lbz2
LIBSSTATIC_CONFIG          := -lfreetype -lz -lbz2 -L/opt/homebrew/opt/libpng/lib -lpng16 -lz -L/opt/homebrew/Cellar/harfbuzz/8.2.1/lib -L/opt/homebrew/opt/freetype/lib -L/opt/homebrew/opt/libpng/lib -L/opt/homebrew/Cellar/glib/2.78.0/lib -L/opt/homebrew/opt/gettext/lib -L/opt/homebrew/Cellar/pcre2/10.42/lib -L/opt/homebrew/Cellar/graphite2/1.3.14/lib -lharfbuzz -lm -framework ApplicationServices -lfreetype -lbz2 -lpng16 -lz -lglib-2.0 -lintl -liconv -lm -framework Foundation -framework CoreFoundation -framework AppKit -framework Carbon -lpcre2-8 -D_THREAD_SAFE -pthread -lgraphite2
build_libtool_libs         := 
ft_version                 := 26.1.20
