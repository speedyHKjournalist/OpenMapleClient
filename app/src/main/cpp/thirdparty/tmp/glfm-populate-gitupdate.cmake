...
execute_process(
  COMMAND "/usr/bin/git" show-ref "607fc6ff8c89d58641c79adfb00ac9ced3652adc"
  WORKING_DIRECTORY "/Users/renruisi/Downloads/glfw-android-example/app/src/main/cpp/thirdparty/glfm"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "607fc6ff8c89d58641c79adfb00ac9ced3652adc")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("607fc6ff8c89d58641c79adfb00ac9ced3652adc" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/607fc6ff8c89d58641c79adfb00ac9ced3652adc")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/renruisi/Downloads/glfw-android-example/app/src/main/cpp/thirdparty/glfm'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/renruisi/Downloads/glfw-android-example/app/src/main/cpp/thirdparty/glfm'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
